...
const titles = ["Linux System Administrator", "Cloud & DevOps Engineer", "SRE Engineer", "Infrastructure Specialist"];
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-accent/20 bg-accent/5 mb-8 ml-2"
        >
          <span className="font-display text-xs text-accent">F-1 OPT / STEM OPT with EAD</span>
        </motion.div>
        ...
        >
          Engineering resilient cloud infrastructure, automating operations, 
          and maintaining 50+ production servers with 99.9% uptime.
        </motion.p>
